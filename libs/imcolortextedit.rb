...
# Clipboard / edits
  ...
  # Render / tests
  attach_function :Render, :TextEditor_Render,    [:TextEditor_ptr,  :string, :bool, ImVec2.by_value, :bool], :bool
  ...
  module Helpers
    ...
    def create
      ptr = ImGuiColorTextEdit.TextEditor_TextEditor()
      return ptr
    end

    def destroy(ptr)
      ImGuiColorTextEdit.TextEditor_destroy(ptr)
    end

    # Get text that was allocated by C; this will copy to Ruby string and free C memory
    def get_text_alloc(ptr)
      p = ImGuiColorTextEdit.TextEditor_GetText_alloc(ptr)
      return nil if p.null?
      str = p.read_string
      ImGuiColorTextEdit.TextEditor_GetText_free(p)
      str
    end

    # Get static text (do NOT free) — returns Ruby string but underlying memory is static
    def get_text_static(ptr)
      s = ImGuiColorTextEdit.TextEditor_GetText_static(ptr)
      s
    end

    # Convenience: set text
    def set_text(ptr, str)
      ImGuiColorTextEdit.TextEditor_SetText(ptr, str)
    end
  end
