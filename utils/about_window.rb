...
module ImGuiDemo
  ...
  # ShowAboutWindow
  @@show_config_info = FFI::MemoryPointer.new(:bool)
  @@show_config_info.write(:bool,true)
  ...
  def self.ShowAboutWindow(p_open)
    ...
    if @@show_config_info.read(:bool) == true
      ...
      cfginfos_frame = ImVec2.create(0, ImGui::GetTextLineHeightWithSpacing() * 19)
      copy_to_clipboard = ImGui::Button("Copy to clipboard")
      ImGui::BeginChild(ImGui::GetID("cfginfos"), cfginfos_frame, ImGuiChildFlags_FrameStyle, ImGuiWindowFlags_NoMove)
      max_depth = -1
